...
/**
 * Servlet implementation class PreparaEliminaAbitanteServlet
 */
...
public class PreparaEliminaAbitanteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//controllo utente in sessione (va fatto in tutte le servlet)
				...
				Abitante c = abitanteService.caricaSingoloAbitante(idTemp);
				request.setAttribute("abitanteDaEliminare", c);

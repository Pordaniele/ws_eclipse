 ...
 */
@WebServlet("/EliminaAbitanteServlet")
public class EliminaAbitanteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Abitante p1 = abitanteService.getEager(idPagina);

		abitanteService.rimuovi(p1);

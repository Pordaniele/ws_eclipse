...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			n1.setIndirizzo("via della monte");
			n1.setNome("Euronics3");
			negozioService.inserisciNuovo(n1);
			Articolo a1=new Articolo();
			a1.setMatricola("678678");
			a1.setNome("Computer hp");
			a1.setNegozio(negozioService.caricaSingoloNegozio(2L));
			articoloService.inserisciNuovo(a1);

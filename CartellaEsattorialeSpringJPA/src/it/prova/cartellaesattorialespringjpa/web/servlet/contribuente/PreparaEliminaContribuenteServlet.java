...
@WebServlet("/PreparaEliminaContribuenteServlet")
public class PreparaEliminaContribuenteServlet extends HttpServlet {
    ...
    public PreparaEliminaContribuenteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("contribuenteDaEliminare", c1);
		RequestDispatcher rd = request.getRequestDispatcher("/contribuente/eliminaContribuente.jsp");

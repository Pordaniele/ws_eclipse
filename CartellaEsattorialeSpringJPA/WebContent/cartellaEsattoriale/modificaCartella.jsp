...
<h3>Inserisci Abitante</h3>
		...
		<form class="form-horizontal" action="ModificaCartellaServlet"
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" value="${cartellaDaModificare.denominazione }" type="text" id="denominazioneInputId"
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" value="${cartellaDaModificare.importo }" type="text" id="importoInputId"
						name="importoInput">
				</div>
			</div>
			<input class="form-control" value="${cartellaDaModificare.id }" type="hidden" id="idInputId"
						name="idInput">
			<div class="form-group">
				<label class="control-label col-sm-2" for="contribuenteInputId">Contribuente:</label>
			<select name="contribuenteInput">
<%-- 			<option value ="${cartellaDaModificare.contribuente.id }">${cartellaDaModificare.contribuente.nome  } ${cartellaDaModificare.contribuente.cognome }</option> --%>

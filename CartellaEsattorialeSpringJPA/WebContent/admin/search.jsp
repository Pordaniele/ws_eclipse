...
<div class="container">
		...
		<div class="page-header">
			<h3>Pagina di Ricerca Utenti</h3>
		</div>

		<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/SearchUtenteServlet"
			method="post">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-primary btn-md">Effettua
						Ricerca</button>
					<a href="${pageContext.request.contextPath}/admin/PreparaInsertUtenteServlet"

...
public class MunicipioDTO {
	...
	public static List<MunicipioDTO> buildListFromModelList(List<Municipio> input, boolean eager) {
		List<MunicipioDTO> result = new ArrayList<>();

		for (Municipio municipioItem : input) {
			// faccio il binding senza municipio tramite costruttore
			MunicipioDTO municipioDTOtemp = buildMunicipioDTOFromModel(municipioItem, eager);

			result.add(municipioDTOtemp);

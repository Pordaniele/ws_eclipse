...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #e3f2fd;">
	<a class="navbar-brand" href="<%= request.getContextPath()%>/home">EbayJPA</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<c:if test='${userInfo.username!= null }'>
		 <ul class="nav navbar-nav navbar-right">
            <li> <a href="${pageContext.request.contextPath}/user/userHome.jsp">Area Privata</a>
            <p class="navbar-text">Utente: ${userInfo.username }(${userInfo.nome } ${userInfo.cognome } Credito: ${userInfo.creditoResiduo }) 

...
<body>
	<div class="container">
		...
		<form name="myForm" class="form-horizontal" action="${pageContext.request.contextPath}/admin/ExecuteInserisciUtenteServlet"
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="passwordInputId2">Conferma Password:</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="number" id="creditoInputId"
						name="creditoInput">
				</div>
			</div>

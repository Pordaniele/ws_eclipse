...
public class CheckAuthFilter implements Filter {
	...
	private static final String[] EXCLUDED_URLS = { "/login.jsp", "/LoginServlet", "/LogoutServlet", "/css/", "/js/",
			"/home", "/visualizzaDettaglioAnnuncio.jsp", "/VisualizzaDettaglioAnnuncioServlet", "/result.jsp",
			"/home.jsp", "/PrepareCompraServlet", "/SearchAnnunciServlet", "registraUtente.jsp",
			"/RegistraUtenteServlet", "/ExecuteRegistraUtenteServlet" };

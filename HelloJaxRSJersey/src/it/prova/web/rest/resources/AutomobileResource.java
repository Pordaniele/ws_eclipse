...
public class AutomobileResource {
	...
	public Response getAutomobile(@PathParam("id") Long id) {
		...
		Persona automobileDaCaricare = automobileDaoMock.findById(id);
		return Response.status(200).entity(automobileDaCaricare).build();
	}

	@POST
	@Produces(MediaType.APPLICATION_JSON)
	public Response insertiNuovaAutomobile(Persona automobileInput) {
		LOGGER.info("Verbo Http.........................." + request.getMethod());
	...
	public Response listAll() {
		LOGGER.info("Verbo Http.........................." + request.getMethod());
		List<Persona> result = automobileDaoMock.findAll();
	...
	public Response searchAutomobile(@QueryParam("marca") String marca, @QueryParam("modello") String modello) {
		LOGGER.info("Verbo Http.........................." + request.getMethod());
		List<Persona> result = automobileDaoMock.findByFields(marca, modello);
		return Response.status(200).entity(result).build();
	}
	...
	@PUT
	@Produces(MediaType.APPLICATION_JSON)
	public Response aggiornaAutomobile(Persona automobileInput) {
		LOGGER.info("Verbo Http.........................." + request.getMethod());
		Persona result = automobileDaoMock.update(automobileInput);
		return Response.status(200).entity(result).build();
	}

...
<body>
<%
		Persona personaInPagina = (Persona) request.getAttribute("personaDaEliminare");
	%>
...
<a href="EliminaServlet?idPersona=<%=personaInPagina.getId() %>" class="btn btn-info">Eliminalo</a>
<a href="search.jsp" class="btn btn-info">Non eliminare</a>
	</div>
</body>
</html>